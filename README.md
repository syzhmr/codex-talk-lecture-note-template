...
このリポジトリは，集中講義で記録した情報を，Codex と共同で整理するためのテンプレートである。
目的は，集中講義で記録された日程，講義回，話題の流れ，主張，記号，引用箇所，参考文献対応を失わず，後から読める集中講義記録を作ることである。
...
- 手書きノートを最優先資料にする。
- 集中講義の日程，講義回，話題ブロックの順序を保存し，教科書風の章構成へ勝手に組み替えない。
